    ...
    <body>
        <div class="login-div2" align="center">
            <table>
                ...
                <tr>
                    <td colspan="2" align="center"><h1 style="font-family: San -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size: 20px">Add Employee</h1></td>
                </tr>
            </table>
        ...
        <form action="" method="POST" onsubmit="return validate()">
            <table align="center">
                ...
                <tr>
                    <td colspan="2"><input type="submit" name="AddEmployee" id="" value="Add Employee" class="btn-mine"></td>
                    <td></td>
                </tr>
            </table>
            </form>
